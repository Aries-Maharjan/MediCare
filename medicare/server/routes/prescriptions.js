// ─── Prescription Routes ───
// Lab Q26: Prescription details with Patient and Doctor name (INNER JOIN)
const express = require('express');
const router = express.Router();
const db = require('../config/db');
const { authenticate, authorize } = require('../middleware/auth');

// GET /api/prescriptions — Lab Q26: Prescription details JOIN
router.get('/', authenticate, async (req, res) => {
  try {
    // Lab Q26 pattern: Prescription details with Patient and Doctor name
    let query = `
      SELECT
...
// POST /api/prescriptions — Lab Step 3: INSERT INTO Prescriptions
...
// DELETE /api/prescriptions/:id — Lab Step 13: DELETE FROM Prescriptions
